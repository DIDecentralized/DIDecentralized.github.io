...
For now, this might be easier to navigate, if you're already used to the layout. Since, I've started de-constructing infominer33/awesome-decentralized-id **:NOTE**
...
* [Sovrin: A Protocol and Token Whitepaper](https://sovrin.org/wp-content/uploads/Sovrin-Protocol-and-Token-White-Paper.pdf)
